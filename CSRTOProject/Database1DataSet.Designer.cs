...
namespace CSRTOProject {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class LicenceDataTable : global::System.Data.TypedTableBase<LicenceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public LicenceRow AddLicenceRow(string Name, string Address, int Phone, string Type, byte[] Photo, string Payment) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public LicenceRow FindByPhone(int Phone) {
        ...
        public partial class LicenceRow : global::System.Data.DataRow {
            ...
            public int Phone {
                get {
                    return ((int)(this[this.tableLicence.PhoneColumn]));
                }
                set {
            ...
            public string Type {
                get {
                    return ((string)(this[this.tableLicence.TypeColumn]));
                }
                set {
                    this[this.tableLicence.TypeColumn] = value;
                }
            }
            ...
            public byte[] Photo {
                get {
                    return ((byte[])(this[this.tableLicence.PhotoColumn]));
                }
                set {
                    this[this.tableLicence.PhotoColumn] = value;
                }
            }
            ...
            public string Payment {
                get {
                    return ((string)(this[this.tableLicence.PaymentColumn]));
                }
                set {
                    this[this.tableLicence.PaymentColumn] = value;
                }
            }
        }
...
namespace CSRTOProject.Database1DataSetTableAdapters {
    ...
    public partial class LicenceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Licence] WHERE (([Name] = @Original_Name) AND ([Address] = @Or" +
                "iginal_Address) AND ([Phone] = @Original_Phone) AND ([Type] = @Original_Type) AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Licence] ([Name], [Address], [Phone], [Type], [Photo], [Paymen" +
                "t]) VALUES (@Name, @Address, @Phone, @Type, @Photo, @Payment);\r\nSELECT Name, Add" +
                "ress, Phone, Type, Photo, Payment FROM Licence WHERE (Phone = @Phone)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Licence] SET [Name] = @Name, [Address] = @Address, [Phone] = @Phone, [Type] = @Type, [Photo] = @Photo, [Payment] = @Payment WHERE (([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ([Phone] = @Original_Phone) AND ([Type] = @Original_Type) AND ([Payment] = @Original_Payment));
SELECT Name, Address, Phone, Type, Photo, Payment FROM Licence WHERE (Phone = @Phone)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Name, Address, Phone, Type, Photo, Payment FROM dbo.Licence";
        ...
        public virtual int Fill(Database1DataSet.LicenceDataTable dataTable) {
        ...
        public virtual Database1DataSet.LicenceDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet.LicenceDataTable dataTable = new Database1DataSet.LicenceDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet.LicenceDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Name, string Original_Address, int Original_Phone, string Original_Type, string Original_Payment) {
        ...
        public virtual int Insert(string Name, string Address, int Phone, string Type, byte[] Photo, string Payment) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Address, int Phone, string Type, byte[] Photo, string Payment, string Original_Name, string Original_Address, int Original_Phone, string Original_Type, string Original_Payment) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, string Type, byte[] Photo, string Payment, string Original_Name, string Original_Address, int Original_Phone, string Original_Type, string Original_Payment) {
            return this.Update(Name, Address, Original_Phone, Type, Photo, Payment, Original_Name, Original_Address, Original_Phone, Original_Type, Original_Payment);
        }
    }
        ...
        public virtual int UpdateAll(Database1DataSet dataSet) {
            ...
            try {
                ...
                if ((this._licenceTableAdapter != null)) {
                    ...
                    this._licenceTableAdapter.Connection = ((global::System.Data.SqlClient.SqlConnection)(workConnection));
                    this._licenceTableAdapter.Transaction = ((global::System.Data.SqlClient.SqlTransaction)(workTransaction));
                ...
                if ((this._licenceTableAdapter != null)) {
                    this._licenceTableAdapter.Connection = ((global::System.Data.SqlClient.SqlConnection)(revertConnections[this._licenceTableAdapter]));
